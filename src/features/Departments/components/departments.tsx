      ...
      <div className="w-full overflow-x-hidden">
        <section className="bg-linear-to-r from-gray-50 to-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-600 text-lg">{data.header.description}</p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap gap-4 mb-12">
              {depts.map((dept) => (
                <button
                  key={dept.name}
                  className="px-6 py-2 bg-gray-100 hover:bg-blue-600 hover:text-white rounded-lg font-light transition"
                >
                  {dept.name}
                </button>
              ))}
