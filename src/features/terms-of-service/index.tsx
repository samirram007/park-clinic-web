        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="space-y-8">
            <Section title="1. Acceptance of Terms">
              <p>
                By accessing or using the {company.name} website and services,
            ...
            <Section title="2. Description of Services">
              <p>
                {company.name} provides healthcare-related information,
                appointment scheduling, contact services, and career application
                processing through our website. The information provided on this
            ...
            <Section title="4. Medical Disclaimer">
              <p>
                ...
                and other materials, is for informational purposes only. It is
            ...
            <Section title="5. Appointment and Service Booking">
              <p>
                While we strive to accommodate all appointment requests,
                submission of an appointment request through our website does
                not guarantee availability. We reserve the right to reschedule
                or cancel appointments as necessary. Please arrive at least 15
            ...
            <Section title="6. Intellectual Property">
              <p>
                ...
                website are owned by or licensed to {company.name}. You may not
            ...
            <Section title="7. Limitation of Liability">
              <p>
                ...
                your access to, use of, or inability to use our website or
            ...
            <Section title="9. Third-Party Links">
              <p>
                ...
                services that are not owned or controlled by {company.name}. We
            ...
            <Section title="10. Termination">
              <p>
                ...
                website immediately, without prior notice, for any reason,
                including, without limitation, a breach of these Terms of
                Service.
              </p>
            </Section>
