...
import { Briefcase, Mail, Phone, User, FileText, Send, AlertCircle, Calendar, Clock, Building, ChevronDown, Sparkles, ArrowUp } from 'lucide-react'
    ...
    <>
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Join our team of dedicated healthcare professionals. We offer a dynamic environment where you can grow and make a difference.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="mb-16">
          ...
          {jobsLoading ? (<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {[1, 2, 3, 4].map((i) => (
                      ...
                      <div className="flex items-center gap-4 mt-4 text-xs text-slate-400">
                        {job.apply_duration && (
                          <span className="flex items-center gap-1.5 bg-amber-50 text-amber-700 px-2.5 py-1 rounded-full">
                            <Calendar size={12} />
                            Apply by: {new Date(job.apply_duration).toLocaleDateString()}
                          </span>
                        )}
            ...
            <div className="bg-slate-50 rounded-2xl p-8 border border-slate-100 text-center">
              <p className="text-slate-600 mb-4">
                Explore exciting opportunities and grow your future with us. New opportunities will be available soon.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
              <div className="bg-slate-900 px-8 py-6">
                ...
                <p className="text-slate-400 mt-1">Join our growing healthcare team and become part of a modern healthcare environment.</p>
              </div>
              ...
              <div className="p-8">
                ...
                >
                    ...
                    <form.Field
                      ...
                      children={(field) => {
                        ...
                        return (
                          <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-700 flex items-center gap-2">
                              <Briefcase size={16} className="text-slate-400" /> Post Applied For
                            </label>
                            {isOtherPosition ? (
                              <div className="space-y-2">
                              ...
                              <div className="relative">
                                ...
                                >
                                  ...
                                  {jobs.map((job) => (
                                    <option key={job.id} value={job.title} className="text-slate-900">
                                      {job.title}
                                    </option>
                                  ))}
                                  <option value={OTHER_VALUE} className="text-slate-500 italic">── Other (type your own) ──</option>
                                </select>
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-semibold text-slate-700 flex items-center gap-2">
                      <FileText size={16} className="text-slate-400" /> Upload Resume (PDF/DOC)
                    </label>
                    <Input 
                      type="file" 
                      accept=".pdf,.doc,.docx"
                  ...
                  <form.Field
                    ...
                    children={(field) => (
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-slate-700">Message / Cover Letter (Optional)</label>
                        <Textarea
                          name={field.name}
                          value={field.state.value}
                          onBlur={field.handleBlur}
