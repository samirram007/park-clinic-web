...
export default function About() {
  ...
  const accrInView = useInView(accrRef, {
    once: true,
    margin: '0px 0px -100px 0px',
  })
      ...
      <div className="w-full overflow-x-hidden">
        <section className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-blue-100 text-lg">{data.header.description}</p>
            <p className="text-blue-100 text-lg">{data.header.description1}</p>
            <p className="text-blue-100 text-lg">{data.header.description2}</p>
            <p className="text-blue-100 text-lg">{data.header.description3}</p>
          </div>
        </section>

        <section
          ref={statsRef}
          className="bg-gradient-to-b from-white to-blue-50 py-16"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                animate={
                  statsInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -30 }
                }
              ...
              >
                ...
                >
                  {data.stats.map((stat, index) => (
                    ...
                    >
                      <p className="text-4xl font-light text-blue-600 mb-3">
                        {stat.value}
                      </p>
        ...
        <section
          ref={valuesRef}
          className="bg-gradient-to-br from-blue-400 via-purple-500 to-pink-500 py-16"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h3
            ...
            >
              {data.values.map((value, index) => (
                <motion.div
                  key={index}
                  className="bg-white/90 backdrop-blur-sm p-8 rounded-xl shadow-lg border border-white/20 hover:bg-white/95 transition-all duration-300"
                  variants={itemVariants}
                >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div
              ...
              animate={
                accrInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 30 }
              }
              transition={{ duration: 0.6 }}
            >
                      ...
                      <div className="flex-shrink-0 p-6 bg-white border-t">
                        <div className="text-center max-w-4xl mx-auto">
                          ...
                          <p className="text-gray-600 leading-relaxed">
                            Our hospital has been accredited by NABH, ensuring
                            the highest standards of patient safety, care
                            quality, and operational excellence in healthcare
                            delivery.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="flex-shrink-0 p-6 bg-white border-t">
                        <div className="text-center max-w-4xl mx-auto">
                          ...
                          <p className="text-gray-600 leading-relaxed">
                            Our laboratory services are accredited by NABL,
                            ensuring accurate and reliable diagnostic testing
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="flex-shrink-0 p-6 bg-white border-t">
                        <div className="text-center max-w-4xl mx-auto">
                          ...
                          <p className="text-gray-600 leading-relaxed">
                            We maintain ISO certification, demonstrating our
                            commitment to quality management systems and
            ...
            >
              <p className="text-blue-200 text-sm">
                Click on any certification to view details • Our certifications
                ensure the highest standards of healthcare excellence
              </p>
            </motion.div>
          </div>
        </section>
