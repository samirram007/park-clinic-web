      ...
      <section className="bg-slate-50">
          ...
          <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-blue-100 leading-relaxed">
                Complete pharmacy support with genuine medicines, healthcare
                essentials and professional pharmacist assistance for all your
                medical needs.
              </p>
              ...
              <div className="bg-white text-slate-800 rounded-3xl shadow-2xl p-8">
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center">
                    <Pill size={34} className="text-blue-700" />
                  </div>

                  <div>
                    <h2 className="text-2xl font-bold">Pharmacy Support</h2>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-600 mt-4 max-w-2xl mx-auto">
              Comprehensive pharmacy care with expert support and quality
              healthcare products.
            </p>
          </div>
        ...
        <div className="bg-blue-900 text-white">
          <div className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
            <div>
              <h2 className="text-4xl font-bold">Need Medicines Quickly?</h2>

              <p className="mt-4 text-blue-100 leading-relaxed">
                Contact our pharmacy team for medicine availability, emergency
