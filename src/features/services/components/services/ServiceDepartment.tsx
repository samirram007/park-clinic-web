...
const ServiceDepartment: React.FC<ServiceDepartmentProps> = ({
  department,
}) => {
              ...
              {data.features.map((feature: string) => (
                ...
                >
                  ...
                  <p className="text-sm text-slate-600 mt-2">
                    Learn more about our {feature.toLowerCase()} program and how
                    it supports your care journey.
                  </p>
                </div>
              ))}
            </div>
...
function GrabComponent({ componentName }: GrabComponentProps) {
