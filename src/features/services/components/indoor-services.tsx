...
const indoorServicesData = [
  ...
  },
  {
    ...
    highlights: ['Life Support', 'Trauma Support', '24×7 Monitoring'],
    features: [
  ...
  },
  {
    ...
    highlights: ['NICU', 'PICU', 'Neonatal Care'],
    features: [
  ...
  },
  {
    ...
    highlights: ['Joint Care', 'Fracture Management', 'Sports Injury Care'],
    features: [
  ...
  },
  {
    ...
    highlights: ['Brain Surgery', 'Spine Surgery', 'Stroke Management'],
    features: [
