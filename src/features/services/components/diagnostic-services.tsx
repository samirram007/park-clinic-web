...
const indoorServicesData = [
...

  {
    ...
    highlights: ['Brain', 'Spine', 'Chest', 'Abdomen'],
    features: [
      'Quiet Suite.',
...

  {
    ...
    highlights: ['Brain', 'Chest', 'Abdomen', 'Vessels'],
    features: [
...

  {
    ...
    highlights: ['Routine X-Ray', 'Special X-Ray'],
    features: [
...

  {
    ...
    highlights: ['Abdominal', 'Obstetrics & Gynaecological', 'Small Part'],
    features: [
...

  {
    ...
    highlights: ['ECG', 'Echocardiography', 'Colour Doppler'],
    features: [
  ...
  },
  {
    ...
    highlights: ['Non-invasive', 'Safe', 'Painless'],
    features: [
  ...
  },
  {
    ...
    highlights: ['E.M.G', 'N.C.V', 'V.E.P & Beraq'],
    features: [
      'Accurate diagnosis of neurological disorders',
      'Expert evaluation by experienced specialists',
      'Detection and monitoring of epilepsy and seizure disorders',
  ...
  },
  {
    ...
    description:
      'Specialized neuro care providing precise evaluation and personalized treatment for neurological conditions',
    highlights: ['Spine & Back Pain', 'Sports Injury', 'Pain Management'],
    features: [
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-slate-600 mt-5 max-w-3xl mx-auto leading-relaxed">
            ...
            multi-speciality healthcare services with experienced doctors and
                  ...
                  <div className="mt-6 space-y-3">
                    {service.features.map((feature) => (
                      ...
                      >
                        ...
                        <p className="text-sm text-justify">{feature}</p>
                      </div>
                    ))}
                  </div>
