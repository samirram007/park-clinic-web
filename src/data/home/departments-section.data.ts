export const departmentsSectionData = {
  tag: 'SPECIAL DEPARTMENTS',
  title: 'Featured Departments',
  description:
    'Explore our specialized departments staffed with expert physicians and state-of-the-art facilities',
  featured: {
    name: 'Brain & Spine Surgery (Neurosurgery)',
    description:
  ...
  specialties: [
    ...
    {
      name: 'Paediatrics Surgery with NICU & PICU',
      image: '/images/dept-pedia.png',
      description:
        'Merging with the Park Children’s Centre in 2009, this department provides subsidised yet superior care for newborns and children.',
      services: [
